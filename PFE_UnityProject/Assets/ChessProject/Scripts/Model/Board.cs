...
/// </summary>
public class Board {
	//the matrices to change a movement from a board to another one
	private IDictionary<Direction, Passing> convertMatrices; 

	//All the board neighbour of the board
	IDictionary<Direction, Board> neighbour;                
	...
	{
		// Needed for the private recursive method.
	...
	public Position GetPositionFromTo(Vector2 coo, Vector2 movement, ref IList<int[,]> convertMatrices)
	{
		...
		// recursive call of the function with the new board.
		if (passing)
		{
